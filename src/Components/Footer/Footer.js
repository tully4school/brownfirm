    ...
    return (
        <footer>
            <div className="row">
                ...
                <div className="col-lg-5 offset-lg-1 d-inline-flex address">
                    <p className="mx-lg-5 mt-lg-3">526 King Street, Suite 213 | Alexandria, VA 22314</p>
                    <p className="ml-2 mx-lg-5 mt-lg-3">Phone: <a className="text-light" href="tel:703-828-0900">703-828-0900</a></p>
                </div>
            </div>
        </footer>
    )
