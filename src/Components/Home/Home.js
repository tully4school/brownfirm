            ...
            <div className="cards my-5">
                <div className="row">
                    <div className="col-md-4">
                        <Link className="text-dark" Card imgLink={Criminal} cardLabel="Criminal Defense" />
                    </div>
                    <div className="col-md-4">
                        <Link className="text-dark" Card imgLink={Traffic} cardLabel="Traffic Defense" />
                    </div>
                    <div className="col-md-4">
                        <Link className="text-dark" Card imgLink={Civil} cardLabel="Civil Litigation" />
                    </div>
                </div>
            </div>
            <hr />
